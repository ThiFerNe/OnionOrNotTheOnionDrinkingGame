    ...
    public function printMain()
    {
        ...
        <main>
            <article>
                <h1>
                    <?php
                    echo LocalizationHlp::get(LocalizationStore::ID_ERRORDOCUMENT404VIEW_BODY_MAIN_HEADLINE);
                    ?>
                </h1>
                <p>
                    <?php
                    echo LocalizationHlp::get(LocalizationStore::ID_ERRORDOCUMENT404VIEW_BODY_MAIN_PARAGRAPH);
                    ?>
                </p>
            </article>
        </main>
